...
begin
  ...
  AList.Add('1. Die Bereitstellung der Daten erfolgt durch die API der Landesapotheker*innenkammer.');
  AList.Add('2. Alle Angaben erfolgen ohne Gewähr.');
  ...
  AList.Add('6. Sie sind verpflichtet, die ausgegebenen Daten selbst auf Korrektheit und Vollständigkeit zu prüfen.');
  AList.Add('7. Diese Software darf nur in Übereinstimmung mit der internationalen Erklärung der Menschenrechte verwendet werden, wie von der Generalversammlung der ' +
    'Vereinten Nationen am 10. Dezember 1948 beschlossen.');
  AList.Add('8. Die Nutzung der Software oder des Codes ist nur zulässig, wenn diese Lizenz vollumfänglich akzeptiert und eingehalten wird.');
  AList.Add('9. Sollten einzelne Teile dieser Lizenz ungültig sein, so bleiben die restlichen Bestandteile unverändert in Kraft.');
end;
